...
def index():
    response.view='plugin_tagging/index.html'
    ...
    tags = db(db.plugin_tagging_tag).select(orderby=db.plugin_tagging_tag.name.upper())
    return dict(links=links, form=form, tags=tags)
