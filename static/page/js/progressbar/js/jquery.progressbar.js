	...
	$.extend({
		progressBar: new function() {
			...
			this.defaults = {
				...
				boxImage		: '/uds_ict/static/js/progressbar/images/progressbar.gif',						// boxImage : image around the progress bar
				barImage		: {
									0:	'/uds_ict/static/js/progressbar/images/progressbg_red.gif',
									30: '/uds_ict/static/js/progressbar/images/progressbg_orange.gif',
									70: '/uds_ict/static/js/progressbar/images/progressbg_green.gif'
								},
